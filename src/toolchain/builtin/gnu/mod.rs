...
pub fn gfortran() -> CompilerTemplate {
    TemplateDef {
        ...
        standard_min_versions: &[("f2003", "4.4"), ("f2008", "4.6"), ("f2018", "8.0")],
        defaults: &[("std", "f2018")],
...
pub fn gdc() -> CompilerTemplate {
    TemplateDef {
        ...
        structure: &[
            ("include_dir", "-I{path}"),
            ("define", "-fversion={name}"),
            ("define_value", "-fversion={name}"),
            ("output", "-o {path}"),
            ("compile_only", "-c"),
            ("dep_file", "-MMD -MF {path}"),
        ],
